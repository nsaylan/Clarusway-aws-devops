...
```text
724850377345(acount number).dkr.ecr.us-east-1.amazonaws.com/student1-repo/todo-app
```
...
```bash
docker tag todo-app:latest 724850377345.dkr.ecr.us-east-1.amazonaws.com/student1-repo/todo-app:latest
```

- Push the image to your ECR repository and show the pushed image on AWS ECR Console.

```bash
docker push 724850377345.dkr.ecr.us-east-1.amazonaws.com/student1-repo/todo-app:latest
```

- Create an container from image located ECR

```bash
docker pull 724850377345.dkr.ecr.us-east-1.amazonaws.com/student1-repo/todo-app:latest
docker run --name todo -dp 80:3000 724850377345.dkr.ecr.us-east-1.amazonaws.com/student1-repo/todo-app:latest
```
- Stop and remove container
...
```bash
docker run --name todo-v1 -dp 80:3000 724850377345.dkr.ecr.us-east-1.amazonaws.com/student1-repo/todo-app:latest
```
...
```bash
docker tag todo-app:latest 724850377345.dkr.ecr.us-east-1.amazonaws.com/student2-repo/todo-app:latest
docker push 724850377345.dkr.ecr.us-east-1.amazonaws.com/student2-repo/todo-app:latest
```
...
```bash
docker pull 724850377345.dkr.ecr.us-east-1.amazonaws.com/student2-repo/todo-app:latest
docker run -dp 80:3000 724850377345.dkr.ecr.us-east-1.amazonaws.com/student2-repo/todo-app:latest
```
