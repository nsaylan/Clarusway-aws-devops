...
app.config['MYSQL_DATABASE_HOST'] = 'database-1.c90mhmjiphld.us-east-1.rds.amazonaws.com' # RDS'te oluşturulan database endpoint yazılır
app.config['MYSQL_DATABASE_USER'] = 'admin' # RDS'te yazılır.
app.config['MYSQL_DATABASE_PASSWORD'] = '12345678' # RDS'te yazılır.
app.config['MYSQL_DATABASE_DB'] = 'clarusway' # RDS'te yazılır.
